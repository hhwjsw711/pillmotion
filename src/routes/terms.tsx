...
function Terms() {
  return (
    <div className="prose prose-sm dark:prose-invert mx-auto max-w-4xl p-4 py-12">
      ...
      <p>
        <strong>No Control Over AI Output:</strong> We utilize AI technology to
        generate images based on user inputs. While we strive to provide
      ...
      <p>
        <strong>Prohibited Content:</strong> You agree not to use our service to
        generate any content that is NSFW (Not Safe For Work), explicit, or
        illegal in nature. This includes, but is not limited to, content that is
        sexually explicit, violent, defamatory, obscene, or infringes on
        intellectual property rights. Any attempt to generate such content will
      ...
      <p>
        ...
        acknowledge and agree that we shall not be held liable for any damages
        or issues that may arise from your use of such sites.
      </p>
      <p>
      ...
      <p>
        ...
        Privacy Policy. It is your responsibility to review the Privacy Policy
        and understand how your data is handled.
      </p>
      ...
      <p>
        ...
        that we are not affiliated with the third-party services we employ. Any
        issues or concerns related to their services should be directed to the
