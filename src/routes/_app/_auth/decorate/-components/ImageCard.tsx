...
export function ImageCard({ image }: ImageCardProps) {
  ...
  return (
    <Link to={ImageRoute.to} params={{ imageId: image._id.toString() }}>
      <Card className="cursor-pointer hover:shadow-xl transition-shadow flex flex-col gap-2 group border border-[var(--color-border)] relative">
        {/* Status pill */}
        <div
