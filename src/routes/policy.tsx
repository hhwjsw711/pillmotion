  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <article className="prose prose-slate lg:prose-lg mx-auto dark:prose-invert">
        ...
        <p>
          pillmotion.com (‘we’, ‘us’, or ‘our’) provides this Privacy Policy to
          ...
          of our website (‘Site’), accessible from{" "}
          <a href="https://pillmotion.com">https://pillmotion.com</a>, and any
          other services offered by us in connection with our site (any and all
          of the foregoing the ‘Services’).
        </p>
        <p>
          If you have additional questions or require more information about our
          Privacy Policy, do not hesitate to contact us at{" "}
          <a href="mailto:hhwjsw711@gmail.com">hhwjsw711@gmail.com</a>. This
          ...
          <a href="https://pillmotion.com">https://pillmotion.com</a>. This
        ...
        <p>
          <strong>Personal Information:</strong> When you sign up, we are
          provided with your name, email, and profile picture which comes from
          your google account information. We use this information for
          personalization and any essential communication with you. We never
          sell your data.
        </p>
        <p>
        ...
        <p>
          ...
          party's website, application, or online service. The fact that we link
          to a website, content is not an endorsement, authorization or
        ...
        <p>
          ...
          in using Google OAuth, a cookie is generated and stored on your
          device. This cookie is essential for the proper functioning of our
        ...
        <p>
          ...
          reflected by a ‘Last modified’ date below. Thus, we advise you to
